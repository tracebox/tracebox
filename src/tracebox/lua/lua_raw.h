...
struct l_raw_ref : public l_layer_ref<Crafter::RawLayer> {
	l_raw_ref (Crafter::RawLayer *i, lua_State *l)
 	...
 	l_raw_ref(l_raw_ref *r, lua_State *l) : l_layer_ref<Crafter::RawLayer>(r, l) {}
	template<class T>
	l_raw_ref(l_ref<T> *r, Crafter::RawLayer *i, lua_State *l)
		: l_layer_ref<Crafter::RawLayer>(r, i, l) {}
	~l_raw_ref() {}
